...
public:
    ...
    VSOMEIP_EXPORT bool is_logging_loaded() const;
    ...
    VSOMEIP_EXPORT multicast_ttl_t get_multicast_ttl() const;
...
protected:
    ...
    ttl_t sd_ttl_;
    multicast_ttl_t sd_multicast_ttl_;
    ...
    enum element_type_e {
        ...
        ET_SERVICE_DISCOVERY_MULTICAST_TTL,
